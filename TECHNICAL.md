...
> **Примечание**: Пороги установлены низкими из-за отсутствия тестов на UI-компоненты. Цель: 50%+ (Этап I).
...
| G | TanStack Query + optimistic updates | Medium | 🟡 Запланировано |
| H | Skeleton loaders для всех списков | Low | ✅ Выполнено |
| I | Покрытие тестов 50%+ | High | 🔴 В работе (93 серверных ✅ / 47 клиентских) |
| I | E2E: эскалация SLA, автоназначение, экспорт | Medium | 🟡 Запланировано |
| J | Volume для MySQL-бэкапов в docker-compose | Low | 🟡 Запланировано |
| J | Healthcheck всех сервисов | Low | 🟡 Запланировано |
| J | Prometheus/Grafana метрики | Low | 🟡 Запланировано |
