...
> **Примечание**: Пороги установлены низкими из-за отсутствия тестов на UI-компоненты. Этап I выполнен: 70 клиентских + 93 серверных теста.
...
| I | Покрытие тестов 50%+ | High | ✅ (93 серверных ✅ / 70 клиентских ✅) |
